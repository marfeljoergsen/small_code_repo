// g++ shared_ptr_with_class_hierarchy.cpp && ./a.out                                                                        ✔  36064  11:43:40
/*
Demonstration of using shared_ptr with a class hierarchy, showing conversion to
base type possibilities and static and dynamic casts.
*/

// From: https://websites.umich.edu/~eecs381/examples/std_smart_pointer_demos/shared_ptr_inheritance_demo.cpp
/* output
Derived1 1:10
Derived1 1:10
Derived1 1:10
...
public:
   ...
   virtual ~Base() {cout << "Base " << i << " destruction" << endl;}
	...
	virtual void print() const {cout << "Base " << i << endl;}
private:
	int i;
	static int count;
};
...
public:
	...
	int get() const {return i;}
	virtual void print() const {cout << "Base2 " << i << endl;}
private:
	int i;
	static int count;
};
